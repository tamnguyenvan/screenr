...
ApplicationWindow {
    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                CustomButton {
                    text: "Export"
                    iconSource: "qrc:/resources/icons/export.svg"
                    iconSize: 20
                    primaryColor: "#4329F4"
            ...
            RowLayout {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        RowLayout {
                            CustomButton {
                                iconSource: "qrc:/resources/icons/prev.svg"
                            ...
                            CustomButton {
                                iconSource: isPlaying ? "qrc:/resources/icons/pause.svg" : "qrc:/resources/icons/play.svg"
                                primaryColor: "transparent"
                                hoverColor: "#212121"
                            ...
                            CustomButton {
                                iconSource: "qrc:/resources/icons/next.svg"
                                primaryColor: "transparent"
                                hoverColor: "#212121"
                        ...
                        RowLayout {
                            CustomButton {
                                iconSource: "qrc:/resources/icons/cut.svg"
                                primaryColor: "transparent"
                                hoverColor: "#212121"
                            }

                            CustomButton {
                                iconSource: "qrc:/resources/icons/scale.svg"
                                primaryColor: "transparent"
                                hoverColor: "#212121"
                            }
                        }
    ...
    Component.onCompleted: {
        ...
        print('fps', fps, 'total frames', totalFrames, 'video len', videoLen)
        videoController.get_current_frame()
    }
